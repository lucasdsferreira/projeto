...
var validade = document.getElementById("validade"); // variavel que recebe o elemento html 'input' com id #validade

function verificar() { // funçao para verificar se todos os items estao preenchidos antes de adicionar

    if (produto.value == "" && quantidade.value == 0 && preço.value <= 0 && validade.value == "") {
        ...
        window.alert('Preencha o campo "Data de Validade" para adicionar um produto/item no estoque!');
...
function adicionar() { // funcao para adicionar um novo produto ao estoque
    ...
    var val = document.getElementById("validade").value;
